...
$query = "SELECT COUNT(*) AS num FROM user_info WHERE username='" .mysqli_real_escape_string($connection,$username). "'";
...
$query = "SELECT COUNT(*) AS num FROM user_info WHERE email='" .mysqli_real_escape_string($connection,$email). "'";
